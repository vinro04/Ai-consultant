...
def main():
    ...
    st.image("logo.png", caption="Linkedin: linkedin.com/in/vincent-julian-rost | Datenschutz: https://github.com/vinro04/Ai-consultant/blob/main/README.md", use_column_width=True)
