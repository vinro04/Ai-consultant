...
def main():
    ...
    st.image("/Users/vincentrost/Desktop/logo.png", caption="Kontakt: vincentjulian.rost@gmail.com | Linkedin: linkedin.com/in/vincent-julian-rost", use_column_width=True)
